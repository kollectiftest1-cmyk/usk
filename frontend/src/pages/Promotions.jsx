...
const Promotions = () => {
  ...
  return (
    <div className="promotions-page" ref={pageRef}>
      {/* Hero Section */}
      <section className="promotions-hero">
        <div className="hero-overlay"></div>
        <Container>
          <div className="hero-content text-center">
            <h1 className="hero-title">Opportunités et Vie Étudiante</h1>
              ...
              <Col key={index} lg={4} md={6} className="mb-4">
                <Card className="offer-card h-100 scroll-anim">
                  <Card.Body>
                    ...
                    <div className="offer-icon">{promo.icon}</div>
                    <Card.Title as="h3">{promo.title}</Card.Title>
          ...
          <Row className="align-items-center">
            <Col lg={6} className="mb-4 mb-lg-0">
              <div className="student-life-image scroll-anim">
                 {/* Placeholder for an image or a small gallery */}
      ...
      {/* CTA Section */}
      <section className="cta-section-promotions scroll-section py-5">
